...
- Para executar a missao como persona especializada local, usar tambem `.opencode/agents/arquiteto-modernizacao-legado.md` quando existir no workspace.
...
Esta skill e a versao OpenCode da mesma metodologia. Veja `.codex/skills/modernizacao-legado/SKILL.md` e `.claude/skills/modernizacao-legado/SKILL.md` para as versoes Codex e Claude da mesma metodologia. A equivalencia cross-harness e registrada em `docs/comparativo-harnesses.md` quando existir.

- Usar `rg`/`rg --files` para reconhecimento.
- Usar `write`/`edit` para escrever documentacao gerada no workspace.
